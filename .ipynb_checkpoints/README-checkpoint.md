...
dora run solver=musicgen/single_finetune \
    ...
    continue_from=/workspace/Van/MusiConGen/audiocraft/training_weights/xps/musicongen \ 
...
``` shell
dora run solver=musicgen/single_finetune conditioner=chord2music_inattn.yaml continue_from=/workspace/Van/MusiConGen/audiocraft/training_weights/xps/musicongen/checkpoint.th compression_model_checkpoint=//pretrained/facebook/encodec_32khz model/lm/model_scale=medium dset=audio/example transformer_lm.n_q=4 transformer_lm.card=2048
```
